...
CREATE TABLE `order_has_product` (
  ...
  CONSTRAINT `fk_order_has_product_order1` FOREIGN KEY (`oder_id`) REFERENCES `order` (`oder_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2025-02-24 17:21:28
