...
) ENGINE=InnoDB AUTO_INCREMENT=18446744073709551615 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_has_product` (
  ...
  KEY `fk_order_has_product_order1_idx` (`oder_id`),
  CONSTRAINT `fk_order_has_product_order1` FOREIGN KEY (`oder_id`) REFERENCES `order` (`order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2025-02-28 16:41:12
